    ...
    return _then(_value.copyWith(
      ...
      projectID: freezed == projectID
          ...
          : projectID // ignore: cast_nullable_to_non_nullable
              as int?,
      projektTitle: freezed == projektTitle
          ? _value.projektTitle
          : projektTitle // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$TimeEntryImpl extends _TimeEntry {
  ...
  @override
  String toString() {
    return 'TimeEntry(customerName: $customerName, date: $date, description: $description, duration: $duration, endTime: $endTime, id: $id, pauseEnd: $pauseEnd, pauseStart: $pauseStart, projectID: $projectID, projektTitle: $projektTitle, serviceID: $serviceID, serviceTitle: $serviceTitle, startTime: $startTime, type: $type, userID: $userID)';
  }
